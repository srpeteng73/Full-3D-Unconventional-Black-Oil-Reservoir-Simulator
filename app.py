...
# ---------------------------------------------------------------------------
# Brand colors (column 0, no indent)
# ---------------------------------------------------------------------------
GAS_RED   = "#D62728"
OIL_GREEN = "#2CA02C"
        ...
        with st.form("inputs_form"):
            ...
            if submitted:
                st.session_state.inputs = {
                    ...
                    "fluid":   {"mu_oil_cp": float(oil_mu), "b_oil": float(b_oil), "rs_scf_per_stb": float(rs)},
                    "well":    {"lateral_ft": int(lateral_len), "stages": int(stages), "generation": generation},
